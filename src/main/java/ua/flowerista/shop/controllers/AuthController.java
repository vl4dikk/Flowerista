...
public class AuthController {
	...
	public ResponseEntity<?> registrationConfirm (@PathVariable (value = "token") String token){
		...
		if(tokenValidated.equals("invalidToken")) {
			 return ResponseEntity.status(HttpStatus.NOT_FOUND).location(URI.create("http://flowerista-frontend.vercel.app/")).build();
		}if(tokenValidated.equals("expired")) {
			 return ResponseEntity.status(HttpStatus.BAD_REQUEST).location(URI.create("http://flowerista-frontend.vercel.app/")).build();
		}
     return ResponseEntity.status(HttpStatus.ACCEPTED).header(HttpHeaders.LOCATION, "http://flowerista-frontend.vercel.app/login").build();
	}
	...
	public ResponseEntity<?> resetPassword(HttpServletRequest request, 
	  @RequestParam("email") String userEmail) {
	    ...
	    mailSender.send(constructResetTokenEmail("flowerista-frontend.vercel.app", 
